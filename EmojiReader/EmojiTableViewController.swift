...
//  EmojiReader
//
//  Created by INFOLABS on 25.10.2021.
//
...
class EmojiTableViewController: UITableViewController {
    ...
    var objects = [
        ...
        Emoji(emoji: "⚽️", name: "Football", description: "Let's play footbal other", isFavorite: false),
    ...
    override func tableView(_ tableView: UITableView, moveRowAt sourceIndexPath: IndexPath, to destinationIndexPath: IndexPath) {
        let movedEmoju = objects.remove(at: sourceIndexPath.row)
        objects.insert(movedEmoju, at: destinationIndexPath.row)
